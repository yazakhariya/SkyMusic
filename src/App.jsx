    ...
    return (
        <ThemeContext.Provider value={{theme,setTheme}}>
            <Routes>
                ...
                <Route path='/favorites' element={<FavoritesPage getRandomSong={getRandomSong} nextTrack={handleNext} prevTrack={handlePrevious} onPauseClick={setIsPlaying} isPlaying={isPlaying} audio={audio} state={state} controls={controls} setIsPlaying={setIsPlaying} data={data} theme={theme} loggedIn={loggedIn} setLoggedIn={setLoggedIn} />} />
                ...
                <Route path='/collection/1/' element={<Thedayplaylist getRandomSong={getRandomSong} nextTrack={handleNext} prevTrack={handlePrevious} onPauseClick={setIsPlaying} isPlaying={isPlaying} audio={audio} state={state} controls={controls} setIsPlaying={setIsPlaying} theme={theme} loggedIn={loggedIn} setLoggedIn={setLoggedIn} />} />
                <Route path='/collection/2/' element={<OneHundred getRandomSong={getRandomSong} nextTrack={handleNext} prevTrack={handlePrevious} onPauseClick={setIsPlaying} isPlaying={isPlaying} audio={audio} state={state} controls={controls} setIsPlaying={setIsPlaying} theme={theme} loggedIn={loggedIn} setLoggedIn={setLoggedIn} />} />
                <Route path='/collection/3/' element={<Indie getRandomSong={getRandomSong} nextTrack={handleNext} prevTrack={handlePrevious} onPauseClick={setIsPlaying} isPlaying={isPlaying} audio={audio} state={state} controls={controls} setIsPlaying={setIsPlaying} theme={theme} loggedIn={loggedIn} setLoggedIn={setLoggedIn} />} />
            </Routes>
