...
function OneHundredContent({loggedIn, theme, data, setIsPlaying, setNavActive, navActive}) {
    ...
    return (
        <main className={s.main}>
            ...
            <div className={s.main__centerblock}>
                ...
                <div>
            <h2 className={s.centerblock__h2}>100 танцевальных хитов</h2>
...
export default OneHundredContent;
